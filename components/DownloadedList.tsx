...
export const DownloadedList: React.FC<DownloadedListProps> = ({ allBhajans, onSelect, onBack, script }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900">
        ...
        {/* List */}
        <div className="flex-1 overflow-y-auto p-2 pb-[calc(5rem+env(safe-area-inset-bottom))]">
